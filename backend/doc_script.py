...
DOCGEN_TOKENS = (
    ...
    "kpr_cost_rows", "kpr_terms", "kpr_terms_line", "bphtb", "notary_fee", "pph_seller", "promo_discount", "discount_rows",
    "subtotal",
...
LABELS = {
    ...
    "kpr_cost_rows": "Baris biaya KPR", "kpr_terms": "Fasilitas KPR (bank — produk · tenor · bunga)",
    "kpr_terms_line": "Baris 'Fasilitas KPR : …' (kosong bila bukan KPR)", "bphtb": "BPHTB", "notary_fee": "Biaya notaris",
