...
import KprProductsPanel from "@/components/master/KprProductsPanel";
    ...
    <div data-testid={MASTER.page} className="space-y-5">
      ...
      <Tabs defaultValue="doc">
        <TabsList className="flex h-auto flex-wrap justify-start">
          ...
          <TabsTrigger data-testid={MASTER.tabKprProducts} value="kpr">Produk KPR</TabsTrigger>
        ...
        <TabsContent value="kpr" className="mt-4"><EditGate resource="settings"><KprProductsPanel /></EditGate></TabsContent>
